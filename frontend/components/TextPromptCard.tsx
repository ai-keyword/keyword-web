...
export function TextPromptCard({ prompt, displayKeyword = prompt.keyword }: TextPromptCardProps) {
  ...
  return (
    <>
      <button
        ...
        className="flex min-h-72 w-[78vw] max-w-72 shrink-0 snap-start flex-col justify-between rounded-lg border border-zinc-200 bg-white p-5 text-left shadow-sm transition hover:-translate-y-0.5 hover:border-zinc-300 hover:shadow-md sm:w-full sm:max-w-none"
      >
        <div className="space-y-5">
          ...
          <p className="line-clamp-4 text-lg font-black leading-8 text-zinc-950">{filledContent}</p>
          {prompt.description ? (
